...
//            String input;
//            uci.sendCommand("usett");
//            uci.sendCommand("position fen 8/1pr3p1/p7/2b3R1/2P5/3K2k1/5p1p/8 b - - 1 64");
            //uci.sendCommand("position fen 8/1pr3p1/p7/2b3R1/2P2k2/3K4/5p1p/8 w - - 2 65");
//            uci.sendCommand("go depth 6");
//            while(true){
//                input = sc.nextLine();
...
//            System.out.println(Map.PAWN[63-8]);
